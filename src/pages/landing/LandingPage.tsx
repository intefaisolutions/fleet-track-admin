...
const LandingPage: React.FC = () => {
  ...
  const handleSignupSubmit = (e: React.FormEvent) => {
    ...
    if (email && /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)) {
      let subscribers = JSON.parse(
        localStorage.getItem("fleettrack_subscribers") || "[]",
      );
      if (!subscribers.includes(email)) {
        subscribers.push(email);
        localStorage.setItem(
          "fleettrack_subscribers",
  ...
  const trackButtonClick = (buttonName: string) => {
    let clicks = JSON.parse(
      localStorage.getItem("fleettrack_button_clicks") || "{}",
    );
  ...
  useEffect(() => {
    ...
    const driverObserver = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            (entry.target as HTMLElement).style.opacity = "1";
  ...
  return (
    <div className="landing-page-container">
          ...
          <div className="logo">
            ...
            <div className="logo-text">
              <div className="logo-main">
                Fleet<span className="logo-highlight">Track</span>
              </div>
              <div className="logo-sub">Expense Management System</div>
            </div>
          </div>
          <div className="nav-links">
            <a href="#features" onClick={(e) => scrollToTarget(e, "#features")}>
              Features
            </a>
            <a href="#pricing" onClick={(e) => scrollToTarget(e, "#pricing")}>
              Pricing
            </a>
            <a href="#contact" onClick={(e) => scrollToTarget(e, "#contact")}>
              Contact
            </a>
            <a
              href={ROUTES.SIGN_IN}
      ...
      >
        ...
        <a href="#driver-app" onClick={(e) => scrollToTarget(e, "#driver-app")}>
          Driver App
        </a>
        <a href="#contact" onClick={(e) => scrollToTarget(e, "#contact")}>
          Contact
        ...
        <a
          ...
          onClick={(e) => {
            trackButtonClick("Mobile CTA");
            scrollToTarget(e, "#driver-app");
          }}
        >
          Download Driver App
        </a>
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <p className="hero-description">
            Track expenses, manage drivers, and scale your fleet business
            effortlessly with our powerful multi-tenant SaaS platform.
          </p>
          ...
          <form className="signup-form" onSubmit={handleSignupSubmit}>
            ...
            <button
              ...
              onClick={() => trackButtonClick("Notify Me")}
            >
        ...
        <div className="hero-visual">
          <div className="stats-card">
            ...
            <div className="stats-footer">
              <span>
                <i className="fas fa-trending-up"></i> +32% efficiency
              </span>
              <span>
      ...
      <section className="features" id="features">
        <div className="container">
          <div className="section-header">
            ...
            <p>
              Powerful features designed for fleet owners, admins, and drivers
            </p>
          </div>
          ...
          <div className="features-grid">
            ...
            >
              ...
              <p>
                Generate and manage license keys for client companies. Perfect
            ...
            >
              ...
              <p>
                Fuel, Maintenance, Insurance, EMI, Salary, Toll, and
                Miscellaneous – track every rupee.
              </p>
            ...
            >
              ...
              <p>
                Fully isolated environments for each client company. Secure and
                scalable.
              </p>
            ...
            >
              ...
              <p>
                Generate detailed reports and export data for accounting and
                analysis.
              </p>
                  ...
                  >
                    ...
                    <ul className="pricing-features">
                      <li>
                        ...
                        <span>{plan.vehicleLimit} vehicles limit</span>
                      </li>
                      {plan.maxAdmins !== undefined && (
                        <li>
                          <i className="fas fa-check"></i>{" "}
                          <span>Up to {plan.maxAdmins} sub-admin</span>
                        </li>
                      )}
                      {plan.supportType && (
                        <li>
                          <i className="fas fa-check"></i>{" "}
                          <span>{plan.supportType} Support</span>
                        </li>
                      )}
                    ...
                    <div className="pricing-footer">
                      <button
                        ...
                        onClick={() => {
                          ...
                          navigate(
                            `/register-company?planId=${plan._id}&billingPeriod=${isYearly ? "YEARLY" : "MONTHLY"}`,
                          );
                        }}
                      >
        ...
        <div className="container">
          <div className="section-header">
            <div className="section-badge">
              <i className="fas fa-mobile-alt"></i> Driver App
            </div>
            <h2>FleetTrack Driver App</h2>
            <p>
              Designed specifically for drivers to manage trips, expenses, and
              stay connected with the fleet
            </p>
          </div>
          ...
          <div className="driver-wrapper">
            <div className="driver-info">
              ...
              <ul className="driver-features">
                <li
                  ref={(el) => {
                    driverFeaturesRef.current[0] = el;
                  }}
                >
                  ...
                  <div>
                    ...
                    <span>
                      View assigned trips, routes, and delivery schedules
                    </span>
                  </div>
                </li>
                <li
                  ref={(el) => {
                    driverFeaturesRef.current[1] = el;
                  }}
                >
                  ...
                  <div>
                    ...
                    <span>
                      Log fuel, toll, maintenance, and other expenses on-the-go
                    </span>
                  </div>
                </li>
                ...
                <li
                  ref={(el) => {
                    driverFeaturesRef.current[2] = el;
                  }}
                >
                  ...
                  <div>
                    ...
                    <span>
                      Get alerts for new trips, approvals, and important updates
                    </span>
                  </div>
                </li>
                <li
                  ref={(el) => {
                    driverFeaturesRef.current[3] = el;
                  }}
                >
                  ...
                  <div>
                    ...
                    <span>
                      View your daily, weekly, and monthly expense summaries
                    </span>
                  </div>
                </li>
              </ul>
            ...
            <div className="driver-download">
              <div className="download-card">
                ...
                <div className="download-requirements">
                  <span>
                    <i className="fab fa-android"></i> Android 6.0+
                  </span>
                  <span>
                    <i className="fas fa-memory"></i> 1GB RAM
                  </span>
                  <span>
                    <i className="fas fa-database"></i> 100MB Storage
                  </span>
                </div>

                <a
                  href="https://fleettrack-driver-apk.s3.ap-south-1.amazonaws.com/Fleet-Driver-app.apk"
                  download
                ...
                <div className="driver-cta-note">
                  ...
                  <span>
                    This app is only for drivers. Fleet owners use the web
                    dashboard.
                  </span>
                </div>
              </div>
        ...
        <div className="container">
          <div className="contact-wrapper">
            <div className="contact-info">
              ...
              <p>
                Be among the first to know when we launch. Get exclusive early
            ...
            <form className="contact-form" onSubmit={handleContactSubmit}>
              ...
              <button
                type="submit"
                className="btn-primary"
                onClick={() => trackButtonClick("Send Message")}
              >
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-brand">
              ...
              <p>
                Multi-Tenant Fleet Expense Management System for modern
                businesses.
              </p>
            ...
            <div className="footer-links">
              ...
              <a
                href="#features"
                onClick={(e) => scrollToTarget(e, "#features")}
              >
                Features
              </a>
              <a href="#pricing" onClick={(e) => scrollToTarget(e, "#pricing")}>
              ...
              <a
                href="#driver-app"
                onClick={(e) => scrollToTarget(e, "#driver-app")}
              >
                Driver App
              </a>
            </div>
          ...
          <div className="footer-bottom">
            <p>
              &copy; {currentYear} FleetTrack. All rights reserved. |
      ...
      <div
        ...
        style={
          toast.isError ? { background: "#ef4444" } : { background: "#10b981" }
        }
      >
        <i
          className={
            toast.isError ? "fas fa-exclamation-circle" : "fas fa-check-circle"
          }
        ></i>
